...
class BaseSampler:
    ...
    def __init__(
        ...
        print("batch_T (int): number of time-steps per sample batch =", batch_T)
        print("batch_B (int): number of environment instances to run (in parallel), becomes second batch dimension =", batch_B)

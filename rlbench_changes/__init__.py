...
from rlbench.tasks.fast_single2xtarget import FastSingle2xtarget
...
from rlbench.tasks.small_target_reach_no_distractors import SmallTargetReachNoDistractors
from rlbench.tasks.large_target_no_distractors_dt200 import LargeTargetNoDistractorsDt200

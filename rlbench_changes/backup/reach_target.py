...
class ReachTarget(Task):
    ...
    def init_episode(self, index: int) -> List[str]:
        print("REWARD IN PREVIOUS EPISODE: {}".format(self.printreward))
        self.printreward = 0.0
        ...
        # note: Sutton recommends leaving the reward alone and changing the value function
        # or to use shaping or imitation learning
